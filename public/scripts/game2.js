Game2 = {
	...
	// {
		...
		// 		}
		// 	}
		// 	Crafty.sprite(60,72,game.spritepath+"cards/cards.png",cardspos,0);
		// 	//save all avalible cards in cards[]
		// 	$.each(cardspos,function(key,pos){cards.push(key);});
		// 	//end load cards

		// 	//other sprites
		// 	Crafty.sprite(70,83,game.gamefilespath+'images/cardslot.png',{'Cardslot':[0,0]},0);

		// 	//the loading screen that will display while our assets load
		// 	Crafty.scene("loading", function() {
		// 		//Crafty.background("#FFF");
		// 		var itemsToLoad = [
		// 							game.spritepath+"cards/cards.png"
		// 						  ];
		...
		// 	Crafty.background("url('"+game.gamefilespath+"background/background1.png')");
		...
		// 	{
		// 		$.getScript(game.gamefilespath+'components/'+components[i]+'.js',function(){
